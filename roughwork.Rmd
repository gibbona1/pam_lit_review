...
df_analysis <- df |>
  ...
  # Filter out "Other Methods" equivalents
  filter(Method.Tool != "Other Methods") |>
  keep_gt1("Method.Tool")
...
# Display and save
p
ggsave("images/analysismethods_automation_taxa.png", p, width = 330, height = 150, units = "mm")
```
